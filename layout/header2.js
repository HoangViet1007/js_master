window.header2 = {
        ...
        <div class="col-md-12 ">
            ...
            <div class="humberger__menu__wrapper ">
                        ...
                        <li><a href="# ">Pages</a>
                            <ul class="header__menu__dropdown ">
                                <li><a href="./shop-details.html ">Shop
                                            Details</a></li>
                                <li><a href="./shoping-cart.html ">Shoping
                                            Cart</a></li>
                                <li><a href="./checkout.html ">Check
                                            Out</a></li>
                ...
                <div class="humberger__menu__contact ">
                    <ul>
                        <li><i class="fa fa-envelope "></i> hello@colorlib.com
                        </li>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-6 col-md-6 ">
                                <div class="header__top__right ">
                                    ...
                                    <div class="header__top__right__auth ">
                                        <a href="./Admin/dashboard/dashboard.html"><i class="fa fa-user "></i> Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 ">
                            <nav class="header__menu ">
                                <ul>
                                    <li class="active "><a href="./index.html ">Home</a></li>
                                    <li><a href="list-product.html">Shop</a></li>
                                    <li><a href="# ">Pages</a>
                                        <ul class="header__menu__dropdown ">
                                            <li><a href="./shop-details.html ">Shop
                                                        Details</a></li>
    ...
    <div class="container">
            ...
            <div class="col-lg-3">
                <div class="hero__categories">
                    <div class="hero__categories__all">
                        <i class="fa fa-bars"></i>
                        <span style="margin-right: 7px;">All departments</span>
        ...
        `;
        return document.querySelector(".ng-header").innerHTML = header2;
    }
