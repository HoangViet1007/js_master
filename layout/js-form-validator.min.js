(function(q) {
    var r = "validate formatString destroy reload getFormHandle getFields showErrors hideErrors".split(" "),
        m = function(a, b, c) {
            a.JsValidator = this;
            this.settings = { onAir: !0, showErrors: !0, autoHideErrors: !1, autoHideErrorsTimeout: 2E3, locale: "en", messages: {}, rules: {}, errorClassName: "error", removeSpaces: !1, autoTracking: !0, eventsList: ["keyup", "change", "blur"] };
            var d = this;
                        ...
                        case "childList":
                            ...
                            [].forEach.call(a.addedNodes, function(a) {
                                c = a.querySelectorAll ?
                                    a.querySelectorAll("*") : []; - 1 !== ["SELECT", "INPUT", "TEXTAREA", "CHECKBOX", "RADIOBUTTON"].indexOf(a.tagName) && (b = !0);
                                !b && [].forEach.call(c, function(a) {-1 !== ["SELECT", "INPUT", "TEXTAREA", "CHECKBOX", "RADIOBUTTON"].indexOf(a.tagName) && (b = !0) })
                            });
                            b && d.reload()
                    }
                })
    ...
    m.prototype = {
        messages: {
            en: {
                ...
                length: { empty: "Please, Enter a minimum of {0} characters and a maximum of {1}", incorrect: "Incorrect. Enter a minimum of {0} characters and a maximum of {1}" },
                minlength: { empty: "Please, enter at least {0} characters", incorrect: "You have entered less than {0} characters" },
                maxlength: { empty: "Please, enter at maximum {0} characters", incorrect: "You have entered more than {0} characters" },
                maxfilesize: {
        ...
        rules: {
            required: function(a) { return "" !== a },
            notzero: function(a) { return 0 < parseInt(a, 10) },
            integer: function(a) { return (new RegExp(/^[0-9]+$/gi)).test(a) },
            "float": function(a) { a = a.toString().replace(/,/, "."); return this.integer(a) || (new RegExp(/^([0-9])+(\.)([0-9]+$)/gi)).test(a) },
            min: function(a, b) {
                return this["float"](a) ? parseFloat(a) >= parseFloat(b[0]) :
                    parseInt(a, 10) >= parseInt(b[0], 10)
            },
            max: function(a, b) { return this["float"](a) ? parseFloat(a) <= parseFloat(b[0]) : parseInt(a, 10) <= parseInt(b[0], 10) },
            between: function(a, b) { b[1] = b[1] || 999999; return this["float"](a) ? parseFloat(a) >= parseFloat(b[0]) && parseFloat(a) <= parseFloat(b[1]) : this.integer(a) ? parseInt(a, 10) >= parseInt(b[0], 10) && parseInt(a, 10) <= parseInt(b[1], 10) : !1 },
            name: function(a) { return 0 < a.length && 2 > a.length ? !1 : (new RegExp(/^[a-zA-Z\s\u0430-\u044f\u0410-\u042f\u0451\u0401\-]+$/g)).test(a) },
            lastname: function(a) { return this.name(a) },
            phone: function(a) { return a.replace(/[^0-9]+/gi, "").match(/[0-9]+/gi) && 6 > a.replace(/[^0-9]+/gi, "").match(/[0-9]+/gi)[0].length ? !1 : (new RegExp(/^(?:(?:\(?(?:00|\+)([1-4]\d\d|[1-9]\d?)\)?)?[\-\. \\\/]?)?((?:\(?\d{1,}\)?[\-\. \\\/]?){0,})(?:[\-\. \\\/]?(?:#|ext\.?|extension|x)[\-\. \\\/]?(\d+))?$/g)).test(a) },
            email: function(a) { return (new RegExp(/^(("[\w-\s]+")|([\w\-]+(?:\.[\w\-]+)*)|("[\w-\s]+")([\w\-]+(?:\.[\w\-]+)*))(@((?:[\w\-]+\.)*\w[\w\-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i)).test(a) },
            length: function(a, b) { return this.between(a.replace(/\s{2,}/g, " ").length, b) },
            maxlength: function(a, b) { return this.max(a.replace(/\s{2,}/g, " ").length, b) },
            minlength: function(a, b) { return this.min(a.replace(/\s{2,}/g, " ").length, b) },
        ...
        orderFields: function(a, b) {
            var c = this,
                d = {};
            a && b && Object.keys(this.fields).forEach(function(e) { c.fields[e].handle[a] && c.fields[e].handle[a] === b && (d[e] = c.fields[e]) });
            return d
        },
        ...
        _eventChange: function(a) {
            ...
            if ("radio" === a.target.type) {
                ...
                Object.keys(c).forEach(function(a) { b.hideErrors(c[a].handle) })
        ...
        _eventChangeWithDelay: function(a) {
            ...
            this.intervalID = setTimeout(function() { b._eventChange.apply(b, [a]) }, 400)
        },
        applySettings: function(a) {
            var b = this;
            a.rules && Object.keys(a.rules).forEach(function(c) { b.rules[c] = a.rules[c] });
            ...
            Object.keys(a).forEach(function(c) { b.settings[c] = a[c] });
            return this
        },
        getFields: function(a) {
            ...
            Object.keys(a).forEach(function(e) {
                ...
                b[e] = { name: a[e].getAttribute("name"), rules: c, defaultValue: a[e].getAttribute("data-default"), handle: a[e], intervalID: null }
            });
            return b
        },
        validate: function(a) {
                ...
                c[a].rules && Object.keys(c[a].rules).forEach(function(m) {
                    ...
                    switch (c[a].handle.type) {
                        ...
                        case "radio":
                            ...
                            p || (Object.keys(n).forEach(function(a) { try { k = b.settings.messages[b.settings.locale][e].empty } catch (u) { k = b.messages[b.settings.locale][e].empty } }), f = "");
                            break;
                        case "file":
                    ...
                    if (d && ("" !== f || c[a].rules.join("|").match(/\|{0,1}required\|{0,1}/)))
                        if (d && h && f !== h ? (d = !1, l =
                                "incorrect") : d && b.rules[e] && !b.rules[e](f, g) && ("" === f ? (d = !1, l = "empty") : (d = !1, l = "incorrect")), d) b.hideErrors(c[a].handle, !0);
                        else {
                            b.errors = b.errors || {};
                            try { try { k = b.settings.messages[b.settings.locale][e][l] } catch (t) { k = b.messages[b.settings.locale][e][l] } } catch (t) { e = "required", k = b.messages.en[e][l] }!g.length && g.push(f);
        ...
        hideErrors: function(a,
            ...
            var c = this,
                d;
            Object.keys(this.fields).forEach(function(e) { if (a && a === c.fields[e].handle || !a) d = c.fields[e].handle.nextElementSibling, b && c.fields[e].handle.classList.remove(c.settings.errorClassName), d && "validator-error" === d.getAttribute("data-type") && d.parentNode.removeChild(d) })
        },
        showErrors: function(a) {
            ...
            Object.keys(this.errors).forEach(function(c) { a ? Object.keys(b.fields).forEach(function(e) { b.fields[e].handle.getAttribute("name") === a.getAttribute("name") && d(b.fields[e].handle, b.errors[c]) }) : ("0" === c || 0 < c && b.fields[c].name !== b.fields[c - 1].name) && d(b.fields[c].handle, b.errors[c]) });
        ...
        getFormHandle: function() { return this.formHandle },
        formatString: function(a, b) { return a.replace(/\{(\d+)\}/gi, function(a, d) { return a && b[d] ? b[d] : "" }) },
        destroy: function() {
            this.hideErrors(!1, !0);
        ...
        eventsBuilder: function(a) {
            ...
            this.settings.onAir && Object.keys(this.fields).forEach(function(c) {
                [].forEach.call(b.settings.eventsList, function(d) {
                    if ("keyup" ===
                        d) b.fields[c].handle[a](d, b._eventChangeWithDelay);
    ...
    q.Validator = function() {
        var a = function(a, b) {
            ...
            b = function() {};
        b.prototype = {};
        [].forEach.call(r, function(c) { b.prototype[c] = function() { return a[c].apply(a, arguments) } });
